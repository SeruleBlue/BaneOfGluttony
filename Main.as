package  {
	...
	public class Main extends MovieClip {
		...
		public function reInit():void {
			...
			btnsUI.upBtn.visible = false;
			btnsUI.downBtn.visible = false;
			optionsBtn.gotoAndStop(1);
			menuUI.appearanceBtn.gotoAndStop(1);
			menuUI.inventoryBtn.gotoAndStop(1);
			menuUI.skillsBtn.gotoAndStop(1);
			menuUI.questsBtn.gotoAndStop(1);
		...
		public function addText(txt:String):void {
			if (txt != "") {
				mainUI.textField.appendText("\n\n" + txt);
				mainUI.scrollBar.scrollPosition = mainUI.scrollBar.maxScrollPosition;
				mainUI.scrollBar.update();
			}
		}
		
		public function setText(txt:String):void {
			if (txt != "") {
				mainUI.textField.text = txt;
				mainUI.scrollBar.scrollPosition = mainUI.scrollBar.minScrollPosition;
				mainUI.scrollBar.update();
			}
		}
