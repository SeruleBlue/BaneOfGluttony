package  {
	...
	public class SkillDefinitions {
		...
		public static const definitions:Object = {
			"Slime Surrender"	: new Skill( {	name			: "Slime Surrender",
												...
												targetEffects	: [function():Array { return ["currCapacity", Math.round(100 * (EnemyDefinitions.definitions["Slime"].currHP / EnemyDefinitions.definitions["Slime"].maxHP))] }] }),
			"Slime Feed"		: new Skill({	name			: "Slime Feed",
												...
												sourceEffects	: [function():Array { return ["currHP", Math.round(-0.5 * (EnemyDefinitions.definitions["Slime"].atk * 0.5 * EnemyDefinitions.definitions["Slime"].maxHP * 0.1 - (getStat("str") + getStat("def")))) as int] }],
												targetEffects	: [function():Array { return ["currCapacity", Math.round(EnemyDefinitions.definitions["Slime"].atk * 0.5 * EnemyDefinitions.definitions["Slime"].maxHP * 0.1 - (getStat("str") + getStat("def"))) as int] }] })
		};
	}
}
