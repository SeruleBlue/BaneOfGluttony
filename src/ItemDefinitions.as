	...
	public class ItemDefinitions {
		public static const definitions:Object = {
			...
			"Halberd" 			: new Item({name		: "Halberd",
											...
											long		: "As a result, this weapon is considerably heavier than most other spears, much like those who seem to be using it. Commonly used in regimental combat, the halberd is mostly found in the hands of foot soldiers due to its long reach.",
											value		: 210,
											equip		: true,
											weapon		: true,
											twoHanded	: true,
			...
			"Hat"				: new Item({name		: "Hat",
										   	short		: "DEF+1",
											long		: "A simple hat. It's better than nothing.\nDEF+1",
											value		: 15,
											equip		: true,
											head		: true,
											def			: 1}),
			"Cotton Shirt"		: new Item({name		: "Cotton Shirt",
										   	short		: "DEF+3",
											long		: "A simple shirt. It provides little means of defense.\nDEF+3",
											value		: 10,
											equip		: true,
											torso		: true,
											def			: 3}),
			"Denim Pants"		: new Item({name		: "Denim Pants",
										   	short		: "DEF+2",
											long		: "A simple pair of pants. Nothing too special about jeans.\nDEF+2",
											value		: 20,
											equip		: true,
											legs		: true,
											def			: 2}),
			"Shoes"				: new Item({name		: "Shoes",
										   	short		: "DEF+5",
											long		: "A simple pair of shoes. Can't leave home without 'em!\nDEF+5",
											value		: 25,
											equip		: true,
											feet		: true,
											def			: 5}),
			"Guard"				: new Item({name		: "Guard",
										   	short		: "DEF+10",
											long		: "A simple shield. Effectively defends against incoming attacks.\nDEF+10",
											value		: 40,
											equip		: true,
											shield		: true,
											def			: 10})
